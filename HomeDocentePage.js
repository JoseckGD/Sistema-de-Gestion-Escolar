                  ...
                  <Card.Body>
                     <Row justify="center" align="center">
                        <Text h3 color="white" css={{ m: 0 }} >
                           ...
                           {user === 'Alumnos' && 'Alumnos asignadas'}
                        ...
                        <>
                           ...
                           {user === 'Calificaciones' &&
                              <>
                                 ...
                                 <select style={{ color: '#000' }} defaultValue={''} name='alumno' id="" onChange={handleChange}>
                                    <option value="" >Selecionar...</option>
                                    {materiasDocente !== null && materiasDocente.map((el) => (
                                       <option value={el.nombre} key={el.idAlumno}>{el.nombre} </option>
                                    ))}
                                 </select>
                              </>
                           }
